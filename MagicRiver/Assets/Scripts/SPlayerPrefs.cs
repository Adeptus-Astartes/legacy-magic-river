...
public class SPlayerPrefs {
	 ...
	 */
	private static string secretKey = "kurticargoon";
	private static byte[] key = new byte[8] {18, 41, 19, 37, 58, 217, 12, 64};
	private static byte[] iv = new byte[8] {34, 68, 46, 43, 34, 32, 4, 185};
